...
data class RestaurantRequest(
    ...
    @field:NotEmpty(message = "분류명을 입력하세요.") val majorCategory: String? = null,
    @field:NotEmpty(message = "세부 분류명을 입력하세요.") val minorCategory: String? = null,
    ...
    fun toDto(): RestaurantDto {
        return RestaurantDto(
            ...
            majorCategory = majorCategory ?: throw CustomException(ResultStatus.NOT_VALID_REQUEST),
            minorCategory = minorCategory ?: throw CustomException(ResultStatus.NOT_VALID_REQUEST),
